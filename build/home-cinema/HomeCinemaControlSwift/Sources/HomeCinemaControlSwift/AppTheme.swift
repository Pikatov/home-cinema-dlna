...
enum AppTheme: String, CaseIterable, Identifiable {
    ...
    var success: Color {
        switch self {
        case .light:
            return Color(red: 0.27, green: 0.63, blue: 0.41)
        case .dark:
            return Color(red: 0.31, green: 0.67, blue: 0.44)
        }
    }
    ...
    var danger: Color {
        switch self {
        case .light:
            return Color(red: 0.84, green: 0.33, blue: 0.31)
        case .dark:
            return Color(red: 0.93, green: 0.40, blue: 0.38)
        }
    }
    ...
    var heroTop: Color {
        switch self {
        case .light:
            return Color(red: 0.30, green: 0.39, blue: 0.49).opacity(0.92)
        case .dark:
            return Color(red: 0.24, green: 0.30, blue: 0.39).opacity(0.92)
        }
    }
    ...
    var heroBottom: Color {
        switch self {
        case .light:
            return Color(red: 0.23, green: 0.25, blue: 0.31).opacity(0.92)
        case .dark:
            return Color(red: 0.18, green: 0.19, blue: 0.25).opacity(0.94)
        }
    }
